  ...
  async cognitoSignUp() {
    ...
    if (!this.state.passwordChecker.test(this.state.password)) {
      ...
      try {
        ...
        console.log(error);
        alert(
          "An error occured in the singup proccess. Please verify that you are using a unique email and a valid password."
        );
      }
    }
  ...
  render() {
    return (
      <View style={styles.menuStyle}>
        <ScrollView>
          <Text style={styles.categoryTextStyle}>First Name</Text>
          <TextInput
            placeholder="First Name"
            style={styles.textInputStyle}
            onChangeText={(newValue) => this.setState({ firstName: newValue })}
          />
          <Text style={styles.categoryTextStyle}>Last Name</Text>
          <TextInput
          ...
          />
          <Text style={styles.categoryTextStyle}>Password</Text>
          <TextInput
          ...
          />
          <Text style={styles.categoryTextStyle}>Confirm Password</Text>
          <TextInput
            placeholder="Enter Password"
            style={styles.textInputStyle}
            secureTextEntry={true}
            onChangeText={(newValue) =>
              this.setState({ confPassword: newValue })
            }
          />
          ...
          />
          <Text
            style={[styles.categoryTextStyle, styles.registerHintTextStyle]}
          >
            Or register with:
          </Text>
